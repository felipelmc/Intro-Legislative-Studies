...
# @Groseclose1994TestingCommitteeComposition {.unnumbered}
...
# @EpsteinOHalloran1999DelegatingPowers, chapters 1 & 4 {.unnumbered}

## Chapter 1: Paths of Policy Making {.unnumbered}
...
## Chapter 4: The Decision to Delegate {.unnumbered}
...
**Sobre @Groseclose1994TestingCommitteeComposition:** um dos componentes importantes nos estudos legislativos é a composição das comissões e, em particular, a comparação entre a composição das comissões e a composição do plenário. O autor vê dois problemas com os estudos a respeito -- (i) o pressuposto de normalidade dos dados; e (ii) o segundo problema tem a ver com a mensuração (que é de 0 a 100, quando a distribuição normal está no intervalo $(-\infty, +\infty)$). Além disso: o que os autores fazem, em geral, como estratégia de falsificação, é o seguinte: "se não é aleatório, então minha hipótese está correta". Há, no entanto, um salto conceitual para afirmar que a distribuição observada é representativa.

**Sobre @EpsteinOHalloran1999DelegatingPowers:** há custos que envolvem o processo legislativo; tempo e recursos são escassos. A solção para a incapacidade de dar conta de todos os problemas que surgem é delegar. Por que há maior ou menor delegação para o Executivo dependendo das áreas?

Esse texto é uma resposta a Mayhew no livro "Divided we Govern", em que o argumento central é que não importa se o governo é dividido ou unificado. O que ele faz é pegar as bills consideradas extremamente relevantes, levando em consideração um critério técnico das bills e também um critério de relevância pública -- i.e., se as bills fizeram parte da imprensa pública e durante quanto tempo. Daí ele testa se o governo dividido ou unificado importa para a aprovação de bills.

No momento de escrita de uma bill, o Congresso pode definir as regras de implementação ou pode deixar partes em aberto para que o Executivo decida. Isso varia dependendo, por exemplo, de áreas. 

Limitações:

- Assume que a preferência do presidente é igual à da burocracia;
- Não leva em consideração o bureaucratic drift;
- Não considera diferentes tipos de agências burocráticas (com mais ou menos comissionados).

Relação Executivo-Legislativo no Brasil: a lógica da delegação foi entendida como consistente com os comportamentos e padrões legislativos, como quando se trata dos poderes legislativos dos presidentes -- Figueiredo e Limongi (2003) e Almeida (2019).

O aumento do protagonismo do CN na iniciação da legislação pode ser interpretada como uma reversão da delegação ao presidente, motivada por alteração nas preferências dos parlamentares.

Segunda parte da aula, sobre @McCubbins1984CongressionalOversightOverlooked e @McCubbins1989StructureProcessPoliticsPolicy. 

# Quizz {.unnumbered}

> A recente conversa entre os presidentes Lula e Donald Trump é um sinal positivo de busca por entendimento, mas a escolha de Marco Rubio como interlocutor não parece promissora. Rubio, figura anti-esquerda do governo Trump, vê Lula como comunista, o que pode complicar as negociações. Contudo, a troca de ideias entre os líderes, acompanhada por ministros, aponta para possíveis avanços através do diálogo diplomático.
>
> Olá, gente!  Acima vocês encontram o resumo da coluna de Merval Pereira em o Globo, oublicada há 2 dias. O quiz de hoje, então, é: onde está o erro da análise (à luz do modelo espacial de @EpsteinOHalloran1999DelegatingPowers)?

De fato, por @EpsteinOHalloran1999DelegatingPowers, a burocracia tem a mesma preferência do presidente. Além disso, podemos pensar que essa política, num espaço unidimensional, não está num espaço direita-esquerda e, portanto, a preferência ideológica de Rubio é ortogonal.